<div class="md:flex md:flex-row md:item-center md:justify-end md:mb-5">
  ...
  @endif
  <a class="hidden md:inline-block ml-5 button button--primary" href="#">Book Now</a>
</div>
<div class="flex flex-row flex-wrap md:flex-no-wrap items-center md:items-end justify-end relative">
  ...
  <a class="absolute left-0 right-0 md:bottom-brand md:left-0 w-full max-w-brand md:w-auto md:max-w-initial mx-auto md:mx-0 px-5 md:px-0" href="{{ home_url('/') }}">
    @if( $branding )
